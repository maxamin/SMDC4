// Pro_Free_PolygonView.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CPro_Free_PolygonView

IMPLEMENT_DYNCREATE(CPro_Free_PolygonView, CView)

CPro_Free_PolygonView::CPro_Free_PolygonView()
{
	m_AxesT=0;
	m_AxesH=0;
	m_AxesL=0;
...
BEGIN_MESSAGE_MAP(CPro_Free_PolygonView, CView)
	//{{AFX_MSG_MAP(CPro_Free_PolygonView)
...
/////////////////////////////////////////////////////////////////////////////
// CPro_Free_LineView drawing

void CPro_Free_PolygonView::OnDraw(CDC* pDC)
{
	CPro_Free_PolygonDoc* pDoc = (CPro_Free_PolygonDoc*)GetDocument();
...
/////////////////////////////////////////////////////////////////////////////
// CPro_Free_PolygonView diagnostics

#ifdef _DEBUG
void CPro_Free_PolygonView::AssertValid() const
{
	CView::AssertValid();
}

void CPro_Free_PolygonView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_Free_PolygonView message handlers

void CPro_Free_PolygonView::Plot(CDC* pDC,double *xi, double *yi,int N,
...
void CPro_Free_PolygonView::Xtick(CDC* pDC,double xiMIN,double xiMAX) 
{
	CPro_Free_PolygonDoc* pDoc = (CPro_Free_PolygonDoc*)GetDocument();
	CString label;
...
void CPro_Free_PolygonView::TextDraw(CDC* pDC,int x, int y,CString str,COLORREF FontColor,
							int Escapement,
...
void CPro_Free_PolygonView::LineDraw(CDC* pDC,int x1, int y1,int x2, int y2,
...
double CPro_Free_PolygonView::Distance_km(double lat1,double lon1,double lat2,double lon2) 
{
...
void CPro_Free_PolygonView::OnRefresh() 
{
	Invalidate();	
}

void CPro_Free_PolygonView::YtickL(CDC* pDC,double yiMIN,double yiMAX) 
{
	CString label;
...
void CPro_Free_PolygonView::YtickR(CDC* pDC,double yiMIN,double yiMAX) 
{
	CString label;
	double r,step_m,yround=0,yiMAXr;
	int y=0,yNum=20;
...
double CPro_Free_PolygonView::MinValue(double *xi,int N) 
{
...
double CPro_Free_PolygonView::MaxValue(double *xi,int N) 
{
...
void CPro_Free_PolygonView::OnLButtonDown(UINT nFlags, CPoint point) 
{
...
void CPro_Free_PolygonView::OnLButtonUp(UINT nFlags, CPoint point) 
{
	m_bLPressed=false;
	CView::OnLButtonUp(nFlags, point);
}

void CPro_Free_PolygonView::OnMouseMove(UINT nFlags, CPoint point) 
{
	CPro_Free_PolygonDoc* pDoc = (CPro_Free_PolygonDoc*)GetDocument();
...
void CPro_Free_PolygonView::DEG2DMS(CString type,double x,int *xD,int *xM,double *xS,char *xU) 
{
...
int CPro_Free_PolygonView::Round(double x) 
{
	int x1 = (int) x;
	int x2 = x1+1;
...
double CPro_Free_PolygonView::Interp(double *hi , int Np , double x) 
{
	int x1,x2;
	double y;
...
void CPro_Free_PolygonView::PlotPoint(CDC* pDC,double *xi, double *yi,int N,
						double xiMIN,double xiMAX,double yiMIN,double yiMAX,
...
double CPro_Free_PolygonView::InterpXY(double *D0,double *E0,double d,int num)
{
...
void CPro_Free_PolygonView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
	if(pInfo)
		m_rcPrintRect=pInfo->m_rectDraw;
	CView::OnPrint(pDC, pInfo);
}
void CPro_Free_PolygonView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
}
void CPro_Free_PolygonView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/) 
{
}
BOOL CPro_Free_PolygonView::OnPreparePrinting(CPrintInfo* pInfo) 
{
	return DoPreparePrinting(pInfo);
}

void CPro_Free_PolygonView::OnFilePrintPreview() 
{
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarCheck();
	CView::OnFilePrintPreview();
}

void CPro_Free_PolygonView::OnEndPrintPreview(CDC* pDC, CPrintInfo* pInfo, POINT point, CPreviewView* pView) 
{
	CView::OnEndPrintPreview(pDC, pInfo, point, pView);
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarSet();
}

void CPro_Free_PolygonView::OnInitialUpdate() 
{
	CView::OnInitialUpdate();

	CString Title_En  = "Polygon Calculation (Free Space)";
	CString Title_Num = GetDocument()->GetTitle();		Title_Num.Replace(Title_En,"");
	GetParent()->SetWindowText(_Z(Title_En) + Title_Num); 

	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ChangeMenuLang(IDR_SMS4DCTYPE7);
}