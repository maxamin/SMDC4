// Pro_P1812_LineDoc.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CPro_P1812_LineDoc, CDocument)

CPro_P1812_LineDoc::CPro_P1812_LineDoc()
{
	m_ZoomFactor=16;
...
BOOL CPro_P1812_LineDoc::OnNewDocument()
{
...
BEGIN_MESSAGE_MAP(CPro_P1812_LineDoc, CDocument)
	//{{AFX_MSG_MAP(CPro_P1812_LineDoc)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CPro_P1812_LineDoc diagnostics

#ifdef _DEBUG
void CPro_P1812_LineDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CPro_P1812_LineDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1812_LineDoc serialization

void CPro_P1812_LineDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
void CPro_P1812_LineDoc::GetData() 
{
...
double CPro_P1812_LineDoc::Distance_km(double lat1,double lon1,double lat2,double lon2) 
{
...
void CPro_P1812_LineDoc::ReadAntennaData(CString antfile,int *f0,double *rH,double *rV) 
{
	FILE *fid;
...
double CPro_P1812_LineDoc::Azimuth_Deg(double lat1,double lon1,double lat2,double lon2) 
{
	float	lat10 = (float)(lat1*D2R),
			lon10 = (float)(lon1*D2R),
			lat20 = (float)(lat2*D2R),
...
int CPro_P1812_LineDoc::Round(double x) 
{
	int x1 = (int) x;
	int x2 = x1+1;
...
double CPro_P1812_LineDoc::Interp2(int *D0,double *E0,double d,int num) 
{
...
void CPro_P1812_LineDoc::reckon(double lat_deg,double lon_deg,double rng_km,double az_deg,double *latC_deg,double *lonC_deg) 
{
...
void CPro_P1812_LineDoc::LatLon2Point(double lat_deg,double lon_deg,CPoint *PointSt) 
{
...
double CPro_P1812_LineDoc::Point2Hg(CPoint point1) 
{
	int i1=point1.x   ,   j1=(Height-1)-point1.y;
	_int16 Hg=bufArea[i1+Width*j1];
	return (double)Hg;
}
double CPro_P1812_LineDoc::LatLon2Hg0(double lat_deg,double lon_deg) 
{
	CPoint pointi;
...
double CPro_P1812_LineDoc::LatLon2Hg(double lat_deg,double lon_deg)
{
	lon_deg = ((CSMS4DCApp *)AfxGetApp())->ChangeLon(lon_deg,TileX);
...
double CPro_P1812_LineDoc::RoundBUF_Hg(double xps,double yps) 
{
...
double CPro_P1812_LineDoc::Points2HgAvr(CPoint point1 , CPoint point2) 
{
	double HgAvr = 0.0;
	if (point1 != point2)
	{
...
double CPro_P1812_LineDoc::TCAcorr1546(double Tdeg,double f_MHz)
{
...
int CPro_P1812_LineDoc::WarmColdSea(double RLON_deg,double RLAT_deg) 
{
...
int CPro_P1812_LineDoc::LandWarmColdSea(double RLON_deg,double RLAT_deg) 
{
...
double CPro_P1812_LineDoc::D_Sea_kmIDWM(double lat1_deg,double lon1_deg,double lat2_deg,double lon2_deg,
									   double *D_SeaW_km)  
{
...
void CPro_P1812_LineDoc::WarmColdCross(double RLON_deg1,double RLAT_deg1,double RLON_deg2,double RLAT_deg2,
...
double CPro_P1812_LineDoc::LandWarmColdSea_D_Sea_kmIDWM(double lat1_deg,double lon1_deg,double lat2_deg,double lon2_deg,
...
void CPro_P1812_LineDoc::LoadIDWMmap() 
{
...
int CPro_P1812_LineDoc::LandSeaCoastal(double RLON_deg,double RLAT_deg) 
{
	float RLON = (float)(RLON_deg*D2R);
	float RLAT = (float)(RLAT_deg*D2R);
...
int CPro_P1812_LineDoc::dat_filesDATA(CString dat_fname, float data[121][241])
{
	FILE *fp;
...
double CPro_P1812_LineDoc::dat_filesDATAout(double LatM,double LongM, float data[121][241])
{
