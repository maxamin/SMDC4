#if !defined(AFX_PRO_P1546_LINKVIEW_H__3E6FF79E_260C_41FC_AD13_74FA0640CD9B__INCLUDED_)
#define AFX_PRO_P1546_LINKVIEW_H__3E6FF79E_260C_41FC_AD13_74FA0640CD9B__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// Pro_P1546_LinkView.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_LinkView form view
...
class CPro_P1546_LinkView : public CFormView
{
protected:
	CPro_P1546_LinkView();           // protected constructor used by dynamic creation
	DECLARE_DYNCREATE(CPro_P1546_LinkView)

// Form Data
public:
	//{{AFX_DATA(CPro_P1546_LinkView)
	enum { IDD = IDD_P1546_FORM };
	double	m_Gr;
	double	m_Gt;
	double	m_Hr;
	double	m_Ht;
...
// Overrides
	...
	//{{AFX_VIRTUAL(CPro_P1546_LinkView)
	public:
...
//	CString m_kfactor;
	...
	void InitForm(CPro_P1546_LinkDoc* pDoc);
	BOOL m_InitForm;
private:
	CRect m_rcPrintRect;
...
#endif // !defined(AFX_PRO_P1546_LINKVIEW_H__3E6FF79E_260C_41FC_AD13_74FA0640CD9B__INCLUDED_)
