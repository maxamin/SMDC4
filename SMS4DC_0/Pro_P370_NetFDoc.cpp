// Pro_P370_NetFDoc.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CPro_P370_NetFDoc, CDocument)

CPro_P370_NetFDoc::CPro_P370_NetFDoc()
{
	colormaptype="Jet";
...
BOOL CPro_P370_NetFDoc::OnNewDocument()
{
...
BEGIN_MESSAGE_MAP(CPro_P370_NetFDoc, CDocument)
	//{{AFX_MSG_MAP(CPro_P370_NetFDoc)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CPro_P370_NetFDoc diagnostics

#ifdef _DEBUG
void CPro_P370_NetFDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CPro_P370_NetFDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P370_NetFDoc serialization

void CPro_P370_NetFDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P370_NetFDoc commands



void CPro_P370_NetFDoc::GetData()
{
...
//98/01/19
int CPro_P370_NetFDoc::Round(double x) 
{
	int y;
	int x1 = (int)x;
...
double CPro_P370_NetFDoc::Distance_km(double lat1,double lon1,double lat2,double lon2) 
{
...
double CPro_P370_NetFDoc::Azimuth_Deg(double lat1,double lon1,double lat2,double lon2) 
{
	double pi=4.0*atan(1.0);
	float	lat10 = (float)(lat1*pi/180.0),
			lon10 = (float)(lon1*pi/180.0),
...
void CPro_P370_NetFDoc::LatLon2Point(double lat_deg,double lon_deg,CPoint *PointSt) 
{
...
double CPro_P370_NetFDoc::Point2Hg(CPoint point1) 
{
...
void CPro_P370_NetFDoc::reckon(double lat_deg,double lon_deg,double rng_km,double az_deg,double *latC_deg,double *lonC_deg) 
{
	double pi=4.0*atan(1.0);
...
double CPro_P370_NetFDoc::Points2HgAvr(CPoint point1 , CPoint point2) 
{
	double HgAvr = 0.0;
	if (point1 != point2)
	{
...
void CPro_P370_NetFDoc::ReadAntennaData(CString antfile,int *f0,double *rH,double *rV) 
{
	FILE *fid;
...
BOOL CPro_P370_NetFDoc::PeekAndPump()
{
	static MSG msg;
...
double CPro_P370_NetFDoc::Interp2(int *D0,double *E0,double d,int num) 
{
...
int CPro_P370_NetFDoc::WarmColdSea(double RLON_deg,double RLAT_deg) 
{
...
int CPro_P370_NetFDoc::LandWarmColdSea(double RLON_deg,double RLAT_deg) 
{
...
double CPro_P370_NetFDoc::D_Sea_kmIDWM(double lat1_deg,double lon1_deg,double lat2_deg,double lon2_deg,
									   double *D_SeaW_km)  
{
	double pi = 4.0*atan(1.0);
...
void CPro_P370_NetFDoc::WarmColdCross(double RLON_deg1,double RLAT_deg1,double RLON_deg2,double RLAT_deg2,
