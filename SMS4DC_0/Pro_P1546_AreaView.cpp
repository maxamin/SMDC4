// Pro_P1546_AreaView.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CPro_P1546_AreaView, CView)

CPro_P1546_AreaView::CPro_P1546_AreaView()
{
	old_cx=old_cy=600;
	new_cx=new_cy=600;
	m_LegendFlag=false;
...
BEGIN_MESSAGE_MAP(CPro_P1546_AreaView, CView)
	//{{AFX_MSG_MAP(CPro_P1546_AreaView)
	ON_WM_SIZE()
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_AreaView drawing

#include "memdc.h"
void CPro_P1546_AreaView::OnDraw(CDC* pDC)	//98/01/25
{
	CMemDC mDC(pDC);
	OnDraw4(mDC);
}
void CPro_P1546_AreaView::OnDraw4(CDC* pDC)	//98/01/25
{
	CPro_P1546_AreaDoc *pDoc =(CPro_P1546_AreaDoc *) GetDocument();
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_AreaView diagnostics

#ifdef _DEBUG
void CPro_P1546_AreaView::AssertValid() const
{
	CView::AssertValid();
}

void CPro_P1546_AreaView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_AreaView message handlers

void CPro_P1546_AreaView::OnSize(UINT nType, int cx, int cy) 
{
...
void CPro_P1546_AreaView::OnToolsNormalize() 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
...
void CPro_P1546_AreaView::OnShowLegend() 
{
...
void CPro_P1546_AreaView::OnUpdateShowLegend(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(m_LegendFlag ? 1 : 0);
}


void CPro_P1546_AreaView::OnTopo0() 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
...
void CPro_P1546_AreaView::OnUpdateTopo0(CCmdUI* pCmdUI) 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_0" ? 1 : 0);
}

void CPro_P1546_AreaView::OnTopo1() 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
...
void CPro_P1546_AreaView::OnUpdateTopo1(CCmdUI* pCmdUI) 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_1" ? 1 : 0);
}

void CPro_P1546_AreaView::OnJet() 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
...
void CPro_P1546_AreaView::OnUpdateJet(CCmdUI* pCmdUI) 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Jet" ? 1 : 0);
}

void CPro_P1546_AreaView::OnGray() 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
...
void CPro_P1546_AreaView::OnUpdateGray(CCmdUI* pCmdUI) 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Gray" ? 1 : 0);
}

void CPro_P1546_AreaView::OnPink() 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
...
void CPro_P1546_AreaView::OnUpdatePink(CCmdUI* pCmdUI) 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Pink" ? 1 : 0);
}

void CPro_P1546_AreaView::OnCopper() 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
...
void CPro_P1546_AreaView::OnUpdateCopper(CCmdUI* pCmdUI) 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Copper" ? 1 : 0);
}

void CPro_P1546_AreaView::OnGlobe() 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
...
void CPro_P1546_AreaView::OnUpdateGlobe(CCmdUI* pCmdUI) 
{
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Globe" ? 1 : 0);
}

void CPro_P1546_AreaView::OnMouseMove(UINT nFlags, CPoint point) 
{
	///////////////////// StatusBAR/////////////////////////////////////
	CPro_P1546_AreaDoc* pDoc = (CPro_P1546_AreaDoc*)GetDocument();
...
lon = ((CSMS4DCApp *)AfxGetApp())->ReverseLon(lon);
	   ...
	   ((CMainFrame*)(AfxGetApp()->m_pMainWnd))->m_wndStatusBar.SetPaneText(5, string);
		...
		double dist=Distance_km(pDoc->P1546lat_ST,pDoc->P1546lon_ST,lat,lon);
...
double CPro_P1546_AreaView::Distance_km(double lat1,double lon1,double lat2,double lon2) 
{
...
void CPro_P1546_AreaView::DEG2DMS(CString type,double x,int *xD,int *xM,double *xS,char *xU) 
{
	if (x < 0)
	{
		x=-x;
...
void CPro_P1546_AreaView::OnToolsContour() 
{
	CPro_P1546_AreaDoc *pDoc =(CPro_P1546_AreaDoc *) GetDocument();
	CContourDLG cdlg;
...
void CPro_P1546_AreaView::OnToolsCoveragearea() 
{
	CPro_P1546_AreaDoc *pDoc =(CPro_P1546_AreaDoc *) GetDocument();
/*
...
void CPro_P1546_AreaView::OnUpdateToolsCoveragearea(CCmdUI* pCmdUI) 
{
	CPro_P1546_AreaDoc *pDoc =(CPro_P1546_AreaDoc *) GetDocument();
	pCmdUI->SetCheck(pDoc->m_bThreshold);
}

int CPro_P1546_AreaView::Contour(double y,double MinV,double MaxV,int nL) 
{
...
void CPro_P1546_AreaView::LegendLOC(CDC* pDC) 
{
	CPro_P1546_AreaDoc *pDoc =(CPro_P1546_AreaDoc *) GetDocument();
...
void CPro_P1546_AreaView::AreaShow(CDC* pDC) 
{
	CPro_P1546_AreaDoc *pDoc =(CPro_P1546_AreaDoc *) GetDocument();
...
void CPro_P1546_AreaView::OnLButtonDown(UINT nFlags, CPoint point) 
{
	m_bLPressed=true;
	if (m_LegendFlag)
	{
...
void CPro_P1546_AreaView::OnLButtonUp(UINT nFlags, CPoint point) 
{
	m_bLPressed=false;
	m_bLSelect=false;
...
BOOL CPro_P1546_AreaView::OnPreparePrinting(CPrintInfo* pInfo) 
{
	return DoPreparePrinting(pInfo);
}

void CPro_P1546_AreaView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
}
void CPro_P1546_AreaView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/) 
{
}
void CPro_P1546_AreaView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
	if(pInfo)
	{
...
void CPro_P1546_AreaView::OnFilePrintPreview() 
{
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarCheck();
	CView::OnFilePrintPreview();
}

void CPro_P1546_AreaView::OnEndPrintPreview(CDC* pDC, CPrintInfo* pInfo, POINT point, CPreviewView* pView) 
{
	CView::OnEndPrintPreview(pDC, pInfo, point, pView);
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarSet();
}

void CPro_P1546_AreaView::OnToolsContourvalue() 
{
	CPro_P1546_AreaDoc *pDoc =(CPro_P1546_AreaDoc *) GetDocument();
	...
	if(vdlg.DoModal()==IDOK)
	{
		...
		Latst = pDoc->P1546lat_ST;	Lonst = pDoc->P1546lon_ST;
		CString progress_str, progress_char = "|";

		CString str;
		str.Format("%sP1546%d%d%d%d%d%d%d%d%d.txt",pDoc->P1546Name_ST,(int)Lonst,(int)Latst,abs(E),(int)pDoc->P1546time,(int)pDoc->P1546location,(int)pDoc->P1546RxH,(int)pDoc->P1546k,pDoc->P1546syst,pDoc->P1546environment);
...
CString CPro_P1546_AreaView::str_rep(CString str,int num)
{
	CString str1 = str;
	for(int i=0;i<num;i++)
		str1 = str1+str;
...
void CPro_P1546_AreaView::DrawVector(CDC *pDC,CString Vector_filepath,
...
void CPro_P1546_AreaView::LatLon2Point(double lat_deg,double lon_deg,CPoint *PointSt) 
{
	CPro_P1546_AreaDoc *pDoc =(CPro_P1546_AreaDoc *) GetDocument();
...
lon_deg = ((CSMS4DCApp *)AfxGetApp())->ChangeLon(lon_deg,pDoc->TileX);
	...
	double ix = (double)(pDoc->m_ZoomFactor)*((lon_deg - pDoc->P1546lon0)/(pDoc->m_Resolution_x));
	double jy = (double)(pDoc->m_ZoomFactor)*((lat_deg - pDoc->P1546lat0)/(pDoc->m_Resolution_x));
/*
	CRect rect;
	GetClientRect(&rect);
	double W = rect.Width();
...
void CPro_P1546_AreaView::OnToolsDrawcontourfromfile() 
{
	CString sFile, sPath;
...
void CPro_P1546_AreaView::OnDrawVector(CString sFile) 
{
	CVectorDLG Vdlg;
	Vdlg.m_TitleName=sFile;
	if (Vdlg.DoModal()== IDOK)
...
void CPro_P1546_AreaView::OnToolsRemovecontourfromdisplay() 
{
	m_POLYnum = 0;
	InvalidateRect(NULL,false);
}
...
/////////////////////////////Google Earth//////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CPro_P1546_AreaView::CaptureDC()
{
	CPro_P1546_AreaDoc *pDoc =(CPro_P1546_AreaDoc *) GetDocument();
...
double P1546lon_ST = ((CSMS4DCApp *)AfxGetApp())->ReverseLon(pDoc->P1546lon_ST);
...
void CPro_P1546_AreaView::OnToolsGoogle() 
{
	CaptureDC();
}


void CPro_P1546_AreaView::OnFileSaveAs() 
{
	OnFileSave();	
}
void CPro_P1546_AreaView::OnFileSave() 
{
	CPro_P1546_AreaDoc *pDoc =(CPro_P1546_AreaDoc *) GetDocument();
	CString str = pDoc->GetTitle();
...
void CPro_P1546_AreaView::OnInitialUpdate() 
{
	CView::OnInitialUpdate();

	CString Title_En  = "Area Calculation (P1546)";
	CString Title_Num = GetDocument()->GetTitle();		Title_Num.Replace(Title_En,"");
	GetParent()->SetWindowText(_Z(Title_En) + Title_Num); 

	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ChangeMenuLang(IDR_SMS4DCTYPE9);
}

BOOL CPro_P1546_AreaView::OnEraseBkgnd(CDC* pDC) 	//98/01/25
{
	return true;
