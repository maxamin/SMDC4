// Pro_Free_PolygonDoc.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CPro_Free_PolygonDoc

IMPLEMENT_DYNCREATE(CPro_Free_PolygonDoc, CDocument)

CPro_Free_PolygonDoc::CPro_Free_PolygonDoc()
{
	m_ReadyDoc=0;
}

BOOL CPro_Free_PolygonDoc::OnNewDocument()
{
...
BEGIN_MESSAGE_MAP(CPro_Free_PolygonDoc, CDocument)
	//{{AFX_MSG_MAP(CPro_Free_PolygonDoc)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CPro_Free_PolygonDoc diagnostics

#ifdef _DEBUG
void CPro_Free_PolygonDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CPro_Free_PolygonDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_Free_PolygonDoc serialization

void CPro_Free_PolygonDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
/////////////////////////////////////////////////////////////////////////////
// CPro_Free_PolygonDoc commands

void CPro_Free_PolygonDoc::GetData()
{
...
double CPro_Free_PolygonDoc::Distance_km(double lat1,double lon1,double lat2,double lon2) 
{
...
void CPro_Free_PolygonDoc::ReadAntennaData(CString antfile,int *f0,double *rH,double *rV) 
{
	FILE *fid;
...
double CPro_Free_PolygonDoc::Azimuth_Deg(double lat1,double lon1,double lat2,double lon2) 
{
	double pi=4.0*atan(1.0);
...
double CPro_Free_PolygonDoc::Interp2(int *D0,double *E0,double d,int num) 
{
