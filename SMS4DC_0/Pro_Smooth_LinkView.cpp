// Pro_Smooth_LinkView.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CPro_Smooth_LinkView

IMPLEMENT_DYNCREATE(CPro_Smooth_LinkView, CFormView)

CPro_Smooth_LinkView::CPro_Smooth_LinkView()
	: CFormView(CPro_Smooth_LinkView::IDD)
{
	//{{AFX_DATA_INIT(CPro_Smooth_LinkView)
	m_Distance = _T("");
	m_Frequency = 0.0;
	m_FsLoss = _T("");
	m_Gr = 0.0;
...
void CPro_Smooth_LinkView::DoDataExchange(CDataExchange* pDX)
{
	CFormView::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPro_Smooth_LinkView)
...
BEGIN_MESSAGE_MAP(CPro_Smooth_LinkView, CFormView)
	//{{AFX_MSG_MAP(CPro_Smooth_LinkView)
	ON_WM_CTLCOLOR()
...
/////////////////////////////////////////////////////////////////////////////
// CPro_Smooth_LinkView diagnostics

#ifdef _DEBUG
void CPro_Smooth_LinkView::AssertValid() const
{
	CFormView::AssertValid();
}

void CPro_Smooth_LinkView::Dump(CDumpContext& dc) const
{
	CFormView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_Smooth_LinkView message handlers



void CPro_Smooth_LinkView::Plot(CDC* pDC,double *xi, double *yi,int N,
...
void CPro_Smooth_LinkView::DrawAntSymbol(CDC* pDC,double xi, double yi,
						double xiMIN,double xiMAX,double yiMIN,double yiMAX,
...
void CPro_Smooth_LinkView::TextDraw(CDC* pDC,int x, int y,CString str,COLORREF FontColor,
							int Escapement,
...
void CPro_Smooth_LinkView::LineDraw(CDC* pDC,int x1, int y1,int x2, int y2,
...
void CPro_Smooth_LinkView::DEG2DMS(CString type,double x,int *xD,int *xM,double *xS,char *xU) 
{
	if (x < 0)
	{
		x=-x;
...
void CPro_Smooth_LinkView::YtickL(CDC* pDC,double yiMIN,double yiMAX) 
{
...
void CPro_Smooth_LinkView::Xtick(CDC* pDC,double xiMIN,double xiMAX) 
{
	CPro_Smooth_LinkDoc* pDoc = (CPro_Smooth_LinkDoc *)GetDocument();
	CString label;
...
double CPro_Smooth_LinkView::MinValue(double *xi,int N) 
{
...
double CPro_Smooth_LinkView::MaxValue(double *xi,int N) 
{
...
double CPro_Smooth_LinkView::InterpXY(double *D0,double *E0,double d,int num)
{
...
void CPro_Smooth_LinkView::OnDraw(CDC* pDC) 
{
	CPro_Smooth_LinkDoc* pDoc = (CPro_Smooth_LinkDoc *)GetDocument();
...
void CPro_Smooth_LinkView::InitForm(CPro_Smooth_LinkDoc* pDoc) 
{
	UpdateData();
	m_Hr = pDoc->LinkRxH;
...
void CPro_Smooth_LinkView::TxRxObj(CDC* pDC) 
{
...
void CPro_Smooth_LinkView::DrawRect(CDC* pDC,int x1,int y1,int x2,int y2,COLORREF flColor) 
{
	CBrush brush(flColor);
...
void CPro_Smooth_LinkView::DrawRoundRect(CDC* pDC,int x1,int y1,int x2,int y2,COLORREF flColor) 
{
	CBrush brush(flColor);
	CBrush *oldbrush = pDC->SelectObject(&brush);
...
void CPro_Smooth_LinkView::OnBUTTONLink() 
{
	UpdateData();
...
void CPro_Smooth_LinkView::OnRadioLR() 
{
	UpdateData();
...
void CPro_Smooth_LinkView::OnRadioRL() 
{
	OnRadioLR();
}

void CPro_Smooth_LinkView::OnInitialUpdate() 
{
	CFormView::OnInitialUpdate();
	
	CString Title_En  = "Link Calculation (Smooth Earth)";
	...
	UpdateData(false);		
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ChangeMenuLang(IDR_SMS4DCTYPE40);
	((CSMS4DCApp *)AfxGetApp())->TranslateDialog((CDialog *)this);
}

void CPro_Smooth_LinkView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
	if(pInfo)
...
void CPro_Smooth_LinkView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
}
void CPro_Smooth_LinkView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/) 
{
}

BOOL CPro_Smooth_LinkView::OnPreparePrinting(CPrintInfo* pInfo) 
{
...
void CPro_Smooth_LinkView::OnFilePrintPreview() 
{
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarCheck();
	CFormView::OnFilePrintPreview();
}
void CPro_Smooth_LinkView::OnEndPrintPreview(CDC* pDC, CPrintInfo* pInfo, POINT point, CPreviewView* pView) 
{
	CFormView::OnEndPrintPreview(pDC, pInfo, point, pView);
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarSet();
}

HBRUSH CPro_Smooth_LinkView::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
...
void CPro_Smooth_LinkView::OnChangeEDITVSWR2w() 
{
	UpdateData();
	m_VSWR2 = m_VSWR2w;
	UpdateData(false);	
...
void CPro_Smooth_LinkView::OnChangeEDITSw() 
{
	UpdateData();
	m_S = m_Sw;
	UpdateData(false);
