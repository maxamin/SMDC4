// Pro_P370_NetBView.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CPro_P370_NetBView, CView)

CPro_P370_NetBView::CPro_P370_NetBView()
{
	old_cx=old_cy=600;
	new_cx=new_cy=600;
	m_LegendFlag=false;
...
BEGIN_MESSAGE_MAP(CPro_P370_NetBView, CView)
	//{{AFX_MSG_MAP(CPro_P370_NetBView)
	ON_WM_SIZE()
	ON_WM_MOUSEMOVE()
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P370_NetBView drawing

#include "memdc.h"
void CPro_P370_NetBView::OnDraw(CDC* pDC)	//98/01/25
{
	CMemDC mDC(pDC);
	OnDraw4(mDC);
}
void CPro_P370_NetBView::OnDraw4(CDC* pDC)	//98/01/25
{
	CPro_P370_NetBDoc *pDoc =(CPro_P370_NetBDoc *) GetDocument();
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P370_NetBView diagnostics

#ifdef _DEBUG
void CPro_P370_NetBView::AssertValid() const
{
	CView::AssertValid();
}

void CPro_P370_NetBView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P370_NetBView message handlers

void CPro_P370_NetBView::OnSize(UINT nType, int cx, int cy) 
{
...
void CPro_P370_NetBView::OnMouseMove(UINT nFlags, CPoint point) 
{
	///////////////////// StatusBAR/////////////////////////////////////
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
...
lon = ((CSMS4DCApp *)AfxGetApp())->ReverseLon(lon);
	   ...
	   ((CMainFrame*)(AfxGetApp()->m_pMainWnd))->m_wndStatusBar.SetPaneText(3, string);
		...
		string.Format(_Z("Server :")+" %s",( (E==0) ? _Z("No Station") : pDoc->P370Name_ST[E-1]) );
...
void CPro_P370_NetBView::DEG2DMS(CString type,double x,int *xD,int *xM,double *xS,char *xU) 
{
	if (x < 0)
	{
		x=-x;
...
void CPro_P370_NetBView::OnToolsThreshold() 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
...
void CPro_P370_NetBView::OnTopo0() 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
...
void CPro_P370_NetBView::OnUpdateTopo0(CCmdUI* pCmdUI) 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_0" ? 1 : 0);
}

void CPro_P370_NetBView::OnTopo1() 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
...
void CPro_P370_NetBView::OnUpdateTopo1(CCmdUI* pCmdUI) 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_1" ? 1 : 0);
}

void CPro_P370_NetBView::OnJet() 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
...
void CPro_P370_NetBView::OnUpdateJet(CCmdUI* pCmdUI) 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Jet" ? 1 : 0);
}

void CPro_P370_NetBView::OnGray() 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
...
void CPro_P370_NetBView::OnUpdateGray(CCmdUI* pCmdUI) 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Gray" ? 1 : 0);
}

void CPro_P370_NetBView::OnPink() 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
...
void CPro_P370_NetBView::OnUpdatePink(CCmdUI* pCmdUI) 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Pink" ? 1 : 0);
}

void CPro_P370_NetBView::OnCopper() 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
...
void CPro_P370_NetBView::OnUpdateCopper(CCmdUI* pCmdUI) 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Copper" ? 1 : 0);
}

void CPro_P370_NetBView::OnGlobe() 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
...
void CPro_P370_NetBView::OnUpdateGlobe(CCmdUI* pCmdUI) 
{
	CPro_P370_NetBDoc* pDoc = (CPro_P370_NetBDoc*)GetDocument();
...
void CPro_P370_NetBView::OnShowLegend() 
{
...
void CPro_P370_NetBView::OnUpdateShowLegend(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(m_LegendFlag ? 1 : 0);
	
}

void CPro_P370_NetBView::LegendLOC(CDC* pDC) 
{
	CPro_P370_NetBDoc *pDoc =(CPro_P370_NetBDoc *) GetDocument();
...
//		RGBt[i]=m_tile.RGBt[ tt*(i) ];		//98/01/19
	...
	for ( i=0;i<Nrow;i++)
	{
		label.Format("%s",pDoc->P370Name_ST[Nrow-1-i]);
...
void CPro_P370_NetBView::OnLButtonDown(UINT nFlags, CPoint point) 
{
	m_bLPressed=true;
	if (m_LegendFlag)
	{
...
void CPro_P370_NetBView::OnLButtonUp(UINT nFlags, CPoint point) 
{
	m_bLPressed=false;
	m_bLSelect=false;
...
BOOL CPro_P370_NetBView::OnPreparePrinting(CPrintInfo* pInfo) 
{
	return DoPreparePrinting(pInfo);
}

void CPro_P370_NetBView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
}
void CPro_P370_NetBView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/) 
{
}
void CPro_P370_NetBView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
	if(pInfo)
	{
...
void CPro_P370_NetBView::OnFilePrintPreview() 
{
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarCheck();
	CView::OnFilePrintPreview();
}
void CPro_P370_NetBView::OnEndPrintPreview(CDC* pDC, CPrintInfo* pInfo, POINT point, CPreviewView* pView) 
{
...
/////////////////////////////Google Earth//////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CPro_P370_NetBView::CaptureDC()
{
	CPro_P370_NetBDoc *pDoc =(CPro_P370_NetBDoc *) GetDocument();
...
void CPro_P370_NetBView::OnToolsGoogle() 
{
	CaptureDC();
}

void CPro_P370_NetBView::OnFileSaveAs() 
{
	OnFileSave();	
}

void CPro_P370_NetBView::OnFileSave() 
{
	CPro_P370_NetBDoc *pDoc =(CPro_P370_NetBDoc *) GetDocument();
	CString str = pDoc->GetTitle();
...
void CPro_P370_NetBView::OnInitialUpdate() 
{
	CView::OnInitialUpdate();

	CString Title_En  = "Best Server (P370)";
	CString Title_Num = GetDocument()->GetTitle();		Title_Num.Replace(Title_En,"");
	GetParent()->SetWindowText(_Z(Title_En) + Title_Num); 
	
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ChangeMenuLang(IDR_SMS4DCTYPE14);
}

BOOL CPro_P370_NetBView::OnEraseBkgnd(CDC* pDC) 	//98/01/25
{
	return true;				
