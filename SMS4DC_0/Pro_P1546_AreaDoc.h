#if !defined(AFX_PRO_P1546_AREADOC_H__7331BA6A_A759_4F50_AB6D_73A454F58EEA__INCLUDED_)
#define AFX_PRO_P1546_AREADOC_H__7331BA6A_A759_4F50_AB6D_73A454F58EEA__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// Pro_P1546_AreaDoc.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_AreaDoc document

#include "Tile.h"

class CPro_P1546_AreaDoc : public CDocument
{
protected:
	CPro_P1546_AreaDoc();           // protected constructor used by dynamic creation
	DECLARE_DYNCREATE(CPro_P1546_AreaDoc)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CPro_P1546_AreaDoc)
	public:
...
public:
	...
	//	double zsigmaLcrr(int p,int srv,double f_MHz,double L,double *sigmaL);
	//	double Qi(double x);
...
#endif // !defined(AFX_PRO_P1546_AREADOC_H__7331BA6A_A759_4F50_AB6D_73A454F58EEA__INCLUDED_)
