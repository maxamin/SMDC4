// Area3DPropDLG.cpp : implementation file
//
...
CArea3DPropDLG::CArea3DPropDLG(CArea3DView* p)
 : CDialog(CArea3DPropDLG::IDD, p)
{
	m_pView = p;
...
//CArea3DPropDLG::CArea3DPropDLG(CWnd* pParent /*=NULL*/)
//	: CDialog(CArea3DPropDLG::IDD, pParent)
//{
//	//{{AFX_DATA_INIT(CArea3DPropDLG)
//		// NOTE: the ClassWizard will add member initialization here
//	//}}AFX_DATA_INIT
//}


void CArea3DPropDLG::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CArea3DPropDLG)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CArea3DPropDLG, CDialog)
	//{{AFX_MSG_MAP(CArea3DPropDLG)
	ON_WM_CLOSE()
	ON_WM_HSCROLL()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
/////////////////////////////////////////////////////////////////////////////
// CArea3DPropDLG message handlers

void CArea3DPropDLG::OnClose() 
{
	m_pView->m_pDlg = 0;
	CDialog::OnClose();
	delete this;	
...
void CArea3DPropDLG::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
...
BOOL CArea3DPropDLG::OnInitDialog() 
{
...
int CArea3DPropDLG::GetSliderNum(HWND hwnd, UINT& nID)
{
