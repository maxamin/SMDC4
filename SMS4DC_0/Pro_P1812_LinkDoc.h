#if !defined(AFX_PRO_P1812_LINKDOC_H__7162B19E_DB95_4BA7_9457_53D3173CC316__INCLUDED_)
#define AFX_PRO_P1812_LINKDOC_H__7162B19E_DB95_4BA7_9457_53D3173CC316__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// Pro_P1812_LinkDoc.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CPro_P1812_LinkDoc document

class CPro_P1812_LinkDoc : public CDocument
{
protected:
	CPro_P1812_LinkDoc();           // protected constructor used by dynamic creation
	DECLARE_DYNCREATE(CPro_P1812_LinkDoc)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CPro_P1812_LinkDoc)
	public:
...
public:
	...
	CString LinkName_Rx;
	double	m_heff,m_Distance,m_FsLoss,m_Loss1812,m_RxCL,m_TxCL,m_TotalLoss;
	...
	int LinkSrv,LinkClutter, LinkIODoor;
	_int16 m_NoData;
...
#endif // !defined(AFX_PRO_P1812_LINKDOC_H__7162B19E_DB95_4BA7_9457_53D3173CC316__INCLUDED_)
