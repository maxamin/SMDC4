// Pro_LoS_PolygonDoc.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CPro_LoS_PolygonDoc, CDocument)

CPro_LoS_PolygonDoc::CPro_LoS_PolygonDoc()
{
	m_ReadyDoc=0;
	m_ZoomFactor=1;
}

BOOL CPro_LoS_PolygonDoc::OnNewDocument()
{
...
BEGIN_MESSAGE_MAP(CPro_LoS_PolygonDoc, CDocument)
	//{{AFX_MSG_MAP(CPro_LoS_PolygonDoc)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CPro_LoS_PolygonDoc diagnostics

#ifdef _DEBUG
void CPro_LoS_PolygonDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CPro_LoS_PolygonDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_LoS_PolygonDoc serialization

void CPro_LoS_PolygonDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
/////////////////////////////////////////////////////////////////////////////
// CPro_LoS_PolygonDoc commands


void CPro_LoS_PolygonDoc::GetData()
{
...
double CPro_LoS_PolygonDoc::Distance_km(double lat1,double lon1,double lat2,double lon2) 
{
...
double CPro_LoS_PolygonDoc::Azimuth_Deg(double lat1,double lon1,double lat2,double lon2) 
{
	double pi=4.0*atan(1.0);
...
double CPro_LoS_PolygonDoc::Interp2(int *D0,double *E0,double d,int num) 
{
...
void CPro_LoS_PolygonDoc::reckon(double lat_deg,double lon_deg,double rng_km,double az_deg,double *latC_deg,double *lonC_deg) 
{
	double pi=4.0*atan(1.0);
	double R=6371.0;
...
void CPro_LoS_PolygonDoc::LatLon2Point(double lat_deg,double lon_deg,CPoint *PointSt) 
{
...
double CPro_LoS_PolygonDoc::Point2Hg(CPoint point1) 
{
