// Int_BT2BT_FreeView.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CInt_BT2BT_FreeView, CView)

CInt_BT2BT_FreeView::CInt_BT2BT_FreeView()
{
	old_cx=old_cy=600;
	new_cx=new_cy=600;
...
BEGIN_MESSAGE_MAP(CInt_BT2BT_FreeView, CView)
	//{{AFX_MSG_MAP(CInt_BT2BT_FreeView)
	ON_WM_SIZE()
...
/////////////////////////////////////////////////////////////////////////////
// CInt_BT2BT_FreeView drawing

#include "memdc.h"
void CInt_BT2BT_FreeView::OnDraw(CDC* pDC)	//98/01/25
{
	CMemDC mDC(pDC);
	OnDraw4(mDC);
}
void CInt_BT2BT_FreeView::OnDraw4(CDC* pDC)	//98/01/25
{
	CInt_BT2BT_FreeDoc *pDoc =(CInt_BT2BT_FreeDoc *) GetDocument();
...
/////////////////////////////////////////////////////////////////////////////
// CInt_BT2BT_FreeView diagnostics

#ifdef _DEBUG
void CInt_BT2BT_FreeView::AssertValid() const
{
	CView::AssertValid();
}

void CInt_BT2BT_FreeView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CInt_BT2BT_FreeView message handlers

int CInt_BT2BT_FreeView::Contour(double y,double MinV,double MaxV,int nL) 
{
...
void CInt_BT2BT_FreeView::OnSize(UINT nType, int cx, int cy) 
{
...
void CInt_BT2BT_FreeView::LegendLOCEu(CDC* pDC) 
{
	CInt_BT2BT_FreeDoc *pDoc =(CInt_BT2BT_FreeDoc *) GetDocument();
...
void CInt_BT2BT_FreeView::LegendLOC(CDC* pDC) 
{
	CInt_BT2BT_FreeDoc *pDoc =(CInt_BT2BT_FreeDoc *) GetDocument();
...
void CInt_BT2BT_FreeView::OnTopo0() 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
...
void CInt_BT2BT_FreeView::OnUpdateTopo0(CCmdUI* pCmdUI) 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_0" ? 1 : 0);
}

void CInt_BT2BT_FreeView::OnTopo1() 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
...
void CInt_BT2BT_FreeView::OnUpdateTopo1(CCmdUI* pCmdUI) 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_1" ? 1 : 0);
}

void CInt_BT2BT_FreeView::OnJet() 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
...
void CInt_BT2BT_FreeView::OnUpdateJet(CCmdUI* pCmdUI) 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Jet" ? 1 : 0);
}

void CInt_BT2BT_FreeView::OnGray() 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
...
void CInt_BT2BT_FreeView::OnUpdateGray(CCmdUI* pCmdUI) 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Gray" ? 1 : 0);
}

void CInt_BT2BT_FreeView::OnPink() 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
...
void CInt_BT2BT_FreeView::OnUpdatePink(CCmdUI* pCmdUI) 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Pink" ? 1 : 0);
}

void CInt_BT2BT_FreeView::OnCopper() 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
...
void CInt_BT2BT_FreeView::OnUpdateCopper(CCmdUI* pCmdUI) 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Copper" ? 1 : 0);
}

void CInt_BT2BT_FreeView::OnGlobe() 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
...
void CInt_BT2BT_FreeView::OnUpdateGlobe(CCmdUI* pCmdUI) 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
...
void CInt_BT2BT_FreeView::OnShowLegend() 
{
...
void CInt_BT2BT_FreeView::OnUpdateShowLegend(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(m_LegendFlag ? 1 : 0);
}

void CInt_BT2BT_FreeView::OnLButtonDown(UINT nFlags, CPoint point) 
{
	m_bLPressed=true;
	if (m_LegendFlag)
	{
...
void CInt_BT2BT_FreeView::OnLButtonUp(UINT nFlags, CPoint point) 
{
	m_bLPressed=false;
	m_bLSelect=false;
...
void CInt_BT2BT_FreeView::OnMouseMove(UINT nFlags, CPoint point) 
{
	///////////////////// StatusBAR/////////////////////////////////////
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
...
void CInt_BT2BT_FreeView::DEG2DMS(CString type,double x,int *xD,int *xM,double *xS,char *xU) 
{
	if (x < 0)
	{
		x=-x;
...
//98/01/19
int CInt_BT2BT_FreeView::Round(double x) 
{
	int y;
	int x1 = (int)x;
...
void CInt_BT2BT_FreeView::OnToolsEu() 
{
	m_EuFlag = !m_EuFlag;
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
	int i,j;
...
void CInt_BT2BT_FreeView::OnUpdateToolsEu(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(m_EuFlag);
}

void CInt_BT2BT_FreeView::OnToolsNormalize() 
{
	CInt_BT2BT_FreeDoc* pDoc = (CInt_BT2BT_FreeDoc*)GetDocument();
...
void CInt_BT2BT_FreeView::OnUpdateToolsNormalize(CCmdUI* pCmdUI) 
{
	pCmdUI->Enable(m_EuFlag);		
}


BOOL CInt_BT2BT_FreeView::OnPreparePrinting(CPrintInfo* pInfo) 
{
	return DoPreparePrinting(pInfo);
}

void CInt_BT2BT_FreeView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
}
void CInt_BT2BT_FreeView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/) 
{
}
void CInt_BT2BT_FreeView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
	if(pInfo)
	{
...
void CInt_BT2BT_FreeView::OnFilePrintPreview() 
{
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarCheck();
	CView::OnFilePrintPreview();
}
void CInt_BT2BT_FreeView::OnEndPrintPreview(CDC* pDC, CPrintInfo* pInfo, POINT point, CPreviewView* pView) 
{
...
/////////////////////////////Google Earth//////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CInt_BT2BT_FreeView::CaptureDC()
{
	CInt_BT2BT_FreeDoc *pDoc =(CInt_BT2BT_FreeDoc *) GetDocument();
...
void CInt_BT2BT_FreeView::OnToolsGoogle() 
{
	CaptureDC();
}

void CInt_BT2BT_FreeView::OnFileSaveAs() 
{
	OnFileSave();	
}
void CInt_BT2BT_FreeView::OnFileSave() 
{
	CInt_BT2BT_FreeDoc *pDoc =(CInt_BT2BT_FreeDoc *) GetDocument();
	CString str = pDoc->GetTitle();
...
void CInt_BT2BT_FreeView::OnInitialUpdate() 
{
	CView::OnInitialUpdate();

	CString Title_En  = "InterferenceBT2BT (Free Space)";
	CString Title_Num = GetDocument()->GetTitle();		Title_Num.Replace(Title_En,"");
	GetParent()->SetWindowText(_Z(Title_En) + Title_Num); 

	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ChangeMenuLang(IDR_SMS4DCTYPE43);
}

BOOL CInt_BT2BT_FreeView::OnEraseBkgnd(CDC* pDC) 	//98/01/25
{
	return true;
