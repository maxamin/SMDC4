#if !defined(AFX_PRO_SMOOTH_LINKVIEW_H__4EA728B6_BE57_4164_B8F4_605C47B44A0E__INCLUDED_)
#define AFX_PRO_SMOOTH_LINKVIEW_H__4EA728B6_BE57_4164_B8F4_605C47B44A0E__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// Pro_Smooth_LinkView.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CPro_Smooth_LinkView form view
...
class CPro_Smooth_LinkView : public CFormView
{
protected:
	CPro_Smooth_LinkView();           // protected constructor used by dynamic creation
	DECLARE_DYNCREATE(CPro_Smooth_LinkView)

// Form Data
public:
	//{{AFX_DATA(CPro_Smooth_LinkView)
	enum { IDD = IDD_Smooth_FORM };
	CString	m_Distance;
	double	m_Frequency;
	CString	m_FsLoss;
	double	m_Gr;
...
// Overrides
	...
	//{{AFX_VIRTUAL(CPro_Smooth_LinkView)
	public:
...
public:
	...
	void InitForm(CPro_Smooth_LinkDoc* pDoc);
	BOOL m_InitForm;
	double m_TotalLoss;
private:
	CRect m_rcPrintRect;
...
#endif // !defined(AFX_PRO_SMOOTH_LINKVIEW_H__4EA728B6_BE57_4164_B8F4_605C47B44A0E__INCLUDED_)
