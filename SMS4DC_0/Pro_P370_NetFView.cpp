// Pro_P370_NetFView.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CPro_P370_NetFView, CView)

CPro_P370_NetFView::CPro_P370_NetFView()
{
	old_cx=old_cy=600;
	new_cx=new_cy=600;
	m_LegendFlag=false;
...
BEGIN_MESSAGE_MAP(CPro_P370_NetFView, CView)
	//{{AFX_MSG_MAP(CPro_P370_NetFView)
	ON_WM_SIZE()
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P370_NetFView drawing

#include "memdc.h"
void CPro_P370_NetFView::OnDraw(CDC* pDC)	//98/01/25
{
	CMemDC mDC(pDC);
	OnDraw4(mDC);
}
void CPro_P370_NetFView::OnDraw4(CDC* pDC)	//98/01/25
{
	CPro_P370_NetFDoc *pDoc =(CPro_P370_NetFDoc *) GetDocument();
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P370_NetFView diagnostics

#ifdef _DEBUG
void CPro_P370_NetFView::AssertValid() const
{
	CView::AssertValid();
}

void CPro_P370_NetFView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P370_NetFView message handlers

void CPro_P370_NetFView::OnSize(UINT nType, int cx, int cy) 
{
...
void CPro_P370_NetFView::OnToolsNormalize() 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
...
void CPro_P370_NetFView::OnShowLegend() 
{
...
void CPro_P370_NetFView::OnUpdateShowLegend(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(m_LegendFlag ? 1 : 0);
}

void CPro_P370_NetFView::OnTopo0() 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
...
void CPro_P370_NetFView::OnUpdateTopo0(CCmdUI* pCmdUI) 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_0" ? 1 : 0);
}

void CPro_P370_NetFView::OnTopo1() 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
...
void CPro_P370_NetFView::OnUpdateTopo1(CCmdUI* pCmdUI) 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_1" ? 1 : 0);
}

void CPro_P370_NetFView::OnJet() 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
...
void CPro_P370_NetFView::OnUpdateJet(CCmdUI* pCmdUI) 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Jet" ? 1 : 0);
}

void CPro_P370_NetFView::OnGray() 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
...
void CPro_P370_NetFView::OnUpdateGray(CCmdUI* pCmdUI) 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Gray" ? 1 : 0);
}

void CPro_P370_NetFView::OnPink() 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
...
void CPro_P370_NetFView::OnUpdatePink(CCmdUI* pCmdUI) 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Pink" ? 1 : 0);
}

void CPro_P370_NetFView::OnCopper() 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
...
void CPro_P370_NetFView::OnUpdateCopper(CCmdUI* pCmdUI) 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Copper" ? 1 : 0);
}

void CPro_P370_NetFView::OnGlobe() 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
...
void CPro_P370_NetFView::OnUpdateGlobe(CCmdUI* pCmdUI) 
{
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
...
void CPro_P370_NetFView::OnMouseMove(UINT nFlags, CPoint point) 
{
	///////////////////// StatusBAR/////////////////////////////////////
	CPro_P370_NetFDoc* pDoc = (CPro_P370_NetFDoc*)GetDocument();
...
void CPro_P370_NetFView::DEG2DMS(CString type,double x,int *xD,int *xM,double *xS,char *xU) 
{
	if (x < 0)
	{
		x=-x;
...
void CPro_P370_NetFView::OnToolsContour() 
{
	CPro_P370_NetFDoc *pDoc =(CPro_P370_NetFDoc *) GetDocument();
	CContourDLG cdlg;
...
void CPro_P370_NetFView::OnToolsCoveragearea() 
{
	CPro_P370_NetFDoc *pDoc =(CPro_P370_NetFDoc *) GetDocument();
/*
...
void CPro_P370_NetFView::OnUpdateToolsCoveragearea(CCmdUI* pCmdUI) 
{
	CPro_P370_NetFDoc *pDoc =(CPro_P370_NetFDoc *) GetDocument();
	pCmdUI->SetCheck(pDoc->m_bThreshold);
}

int CPro_P370_NetFView::Contour(double y,double MinV,double MaxV,int nL) 
{
...
void CPro_P370_NetFView::LegendLOC(CDC* pDC) 
{
	CPro_P370_NetFDoc *pDoc =(CPro_P370_NetFDoc *) GetDocument();
...
void CPro_P370_NetFView::AreaShow(CDC* pDC) 
{
	CPro_P370_NetFDoc *pDoc =(CPro_P370_NetFDoc *) GetDocument();
...
void CPro_P370_NetFView::OnLButtonDown(UINT nFlags, CPoint point) 
{
	m_bLPressed=true;
	if (m_LegendFlag)
	{
...
void CPro_P370_NetFView::OnLButtonUp(UINT nFlags, CPoint point) 
{
	m_bLPressed=false;
	m_bLSelect=false;
...
BOOL CPro_P370_NetFView::OnPreparePrinting(CPrintInfo* pInfo) 
{
	return DoPreparePrinting(pInfo);
}

void CPro_P370_NetFView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
}
void CPro_P370_NetFView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/) 
{
}
void CPro_P370_NetFView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
	if(pInfo)
	{
...
void CPro_P370_NetFView::OnFilePrintPreview() 
{
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarCheck();
	CView::OnFilePrintPreview();
}

void CPro_P370_NetFView::OnEndPrintPreview(CDC* pDC, CPrintInfo* pInfo, POINT point, CPreviewView* pView) 
{
...
/////////////////////////////Google Earth//////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CPro_P370_NetFView::CaptureDC()
{
	CPro_P370_NetFDoc *pDoc =(CPro_P370_NetFDoc *) GetDocument();
...
void CPro_P370_NetFView::OnToolsGoogle() 
{
	CaptureDC();
}

void CPro_P370_NetFView::OnFileSaveAs() 
{
	OnFileSave();	
}
void CPro_P370_NetFView::OnFileSave() 
{
	CPro_P370_NetFDoc *pDoc =(CPro_P370_NetFDoc *) GetDocument();
	CString str = pDoc->GetTitle();
...
void CPro_P370_NetFView::OnInitialUpdate() 
{
	CView::OnInitialUpdate();

	CString Title_En  = "Maximum Field Strength (P370)";
	CString Title_Num = GetDocument()->GetTitle();		Title_Num.Replace(Title_En,"");
	GetParent()->SetWindowText(_Z(Title_En) + Title_Num); 
	
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ChangeMenuLang(IDR_SMS4DCTYPE13);
}


BOOL CPro_P370_NetFView::OnEraseBkgnd(CDC* pDC) 	//98/01/25
{
	return true;				
