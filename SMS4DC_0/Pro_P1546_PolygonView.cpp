// Pro_P1546_PolygonView.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_PolygonView

IMPLEMENT_DYNCREATE(CPro_P1546_PolygonView, CView)

CPro_P1546_PolygonView::CPro_P1546_PolygonView()
{
	m_AxesT=0;
	m_AxesH=0;
	m_AxesL=0;
...
BEGIN_MESSAGE_MAP(CPro_P1546_PolygonView, CView)
	//{{AFX_MSG_MAP(CPro_P1546_PolygonView)
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
	//}}AFX_MSG_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_PolygonView drawing

void CPro_P1546_PolygonView::OnDraw(CDC* pDC)
{
	CPro_P1546_PolygonDoc* pDoc = (CPro_P1546_PolygonDoc*)GetDocument();
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_PolygonView diagnostics

#ifdef _DEBUG
void CPro_P1546_PolygonView::AssertValid() const
{
	CView::AssertValid();
}

void CPro_P1546_PolygonView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_PolygonView message handlers


void CPro_P1546_PolygonView::Plot(CDC* pDC,double *xi, double *yi,int N,
...
void CPro_P1546_PolygonView::Xtick(CDC* pDC,double xiMIN,double xiMAX) 
{
	CPro_P1546_PolygonDoc* pDoc = (CPro_P1546_PolygonDoc*)GetDocument();
	CString label;
...
void CPro_P1546_PolygonView::TextDraw(CDC* pDC,int x, int y,CString str,COLORREF FontColor,
							int Escapement,
...
void CPro_P1546_PolygonView::LineDraw(CDC* pDC,int x1, int y1,int x2, int y2,
...
double CPro_P1546_PolygonView::Distance_km(double lat1,double lon1,double lat2,double lon2) 
{
...
void CPro_P1546_PolygonView::YtickL(CDC* pDC,double yiMIN,double yiMAX) 
{
	CString label;
...
void CPro_P1546_PolygonView::YtickR(CDC* pDC,double yiMIN,double yiMAX) 
{
	CString label;
	double r,step_m,yround=0,yiMAXr;
	int y=0,yNum=20;
...
double CPro_P1546_PolygonView::MinValue(double *xi,int N) 
{
...
double CPro_P1546_PolygonView::MaxValue(double *xi,int N) 
{
...
void CPro_P1546_PolygonView::OnLButtonDown(UINT nFlags, CPoint point) 
{
...
void CPro_P1546_PolygonView::OnLButtonUp(UINT nFlags, CPoint point) 
{
	m_bLPressed=false;
	CView::OnLButtonUp(nFlags, point);
}

void CPro_P1546_PolygonView::OnMouseMove(UINT nFlags, CPoint point) 
{
	CPro_P1546_PolygonDoc* pDoc = (CPro_P1546_PolygonDoc*)GetDocument();
...
void CPro_P1546_PolygonView::DEG2DMS(CString type,double x,int *xD,int *xM,double *xS,char *xU) 
{
	if (x < 0)
	{
		x=-x;
...
int CPro_P1546_PolygonView::Round(double x) 
{
	int x1 = (int) x;
	int x2 = x1+1;
...
double CPro_P1546_PolygonView::Interp(double *hi , int Np , double x) 
{
	int x1,x2;
	double y;
...
void CPro_P1546_PolygonView::PlotPoint(CDC* pDC,double *xi, double *yi,int N,
						double xiMIN,double xiMAX,double yiMIN,double yiMAX,
...
double CPro_P1546_PolygonView::InterpXY(double *D0,double *E0,double d,int num)
{
...
void CPro_P1546_PolygonView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
	if(pInfo)
		m_rcPrintRect=pInfo->m_rectDraw;
	CView::OnPrint(pDC, pInfo);
}
void CPro_P1546_PolygonView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
}
void CPro_P1546_PolygonView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/) 
{
}
BOOL CPro_P1546_PolygonView::OnPreparePrinting(CPrintInfo* pInfo) 
{
	return DoPreparePrinting(pInfo);
}

void CPro_P1546_PolygonView::OnFilePrintPreview() 
{
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarCheck();
	CView::OnFilePrintPreview();
}

void CPro_P1546_PolygonView::OnEndPrintPreview(CDC* pDC, CPrintInfo* pInfo, POINT point, CPreviewView* pView) 
{
...
void CPro_P1546_PolygonView::OnInitialUpdate() 
{
	CView::OnInitialUpdate();

	CString Title_En  = "Polygon Calculation (P1546)";
	CString Title_Num = GetDocument()->GetTitle();		Title_Num.Replace(Title_En,"");
	GetParent()->SetWindowText(_Z(Title_En) + Title_Num); 

	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ChangeMenuLang(IDR_SMS4DCTYPE23);
}
