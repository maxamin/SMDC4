// Pro_P1546_LineDoc.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CPro_P1546_LineDoc, CDocument)

CPro_P1546_LineDoc::CPro_P1546_LineDoc()
{
	m_ZoomFactor=16;
...
BOOL CPro_P1546_LineDoc::OnNewDocument()
{
...
BEGIN_MESSAGE_MAP(CPro_P1546_LineDoc, CDocument)
	//{{AFX_MSG_MAP(CPro_P1546_LineDoc)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_LineDoc diagnostics

#ifdef _DEBUG
void CPro_P1546_LineDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CPro_P1546_LineDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_LineDoc serialization

void CPro_P1546_LineDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
void CPro_P1546_LineDoc::GetData() 
{
...
//		if (h1<0.0)		//for Tropospheric scattering(Ets) calculation, tetamax15 should be calculated whether or not h1 is negative P1546-5
		...
		/////////////////////////////////Rx ttca /////////////////////////////////////////////
// 		if (LineClangle==1)		//for Tropospheric scattering(Ets) calculation, P1546-5
		{
...
//				tetamax16=max(tetamax16   ,(((hii-10.0-m_Hgi)/(dz*1000))-(dz/(2.0*Linek*rearth))));
...
double CPro_P1546_LineDoc::Distance_km(double lat1,double lon1,double lat2,double lon2) 
{
...
void CPro_P1546_LineDoc::ReadAntennaData(CString antfile,int *f0,double *rH,double *rV) 
{
	FILE *fid;
...
double CPro_P1546_LineDoc::Azimuth_Deg(double lat1,double lon1,double lat2,double lon2) 
{
	float	lat10 = (float)(lat1*pi/180.0),
			lon10 = (float)(lon1*pi/180.0),
			lat20 = (float)(lat2*pi/180.0),
...
int CPro_P1546_LineDoc::Round(double x) 
{
	int x1 = (int) x;
	int x2 = x1+1;
...
double CPro_P1546_LineDoc::Interp2(int *D0,double *E0,double d,int num) 
{
...
void CPro_P1546_LineDoc::reckon(double lat_deg,double lon_deg,double rng_km,double az_deg,double *latC_deg,double *lonC_deg) 
{
...
void CPro_P1546_LineDoc::LatLon2Point(double lat_deg,double lon_deg,CPoint *PointSt) 
{
...
double CPro_P1546_LineDoc::Point2Hg(CPoint point1) 
{
	int i1=point1.x   ,   j1=(Height-1)-point1.y;
	_int16 Hg=bufArea[i1+Width*j1];
	return (double)Hg;
}
double CPro_P1546_LineDoc::LatLon2Hg0(double lat_deg,double lon_deg) 
{
	CPoint pointi;
...
double CPro_P1546_LineDoc::LatLon2Hg(double lat_deg,double lon_deg)
{
	lon_deg = ((CSMS4DCApp *)AfxGetApp())->ChangeLon(lon_deg,TileX);
...
double CPro_P1546_LineDoc::RoundBUF_Hg(double xps,double yps) 
{
...
double CPro_P1546_LineDoc::Points2HgAvr(CPoint point1 , CPoint point2) 
{
	double HgAvr = 0.0;
	if (point1 != point2)
	{
...
double CPro_P1546_LineDoc::TCAcorr1546(double Tdeg,double f_MHz)
{
...
int CPro_P1546_LineDoc::WarmColdSea(double RLON_deg,double RLAT_deg) 
{
...
int CPro_P1546_LineDoc::LandWarmColdSea(double RLON_deg,double RLAT_deg) 
{
...
double CPro_P1546_LineDoc::D_Sea_kmIDWM(double lat1_deg,double lon1_deg,double lat2_deg,double lon2_deg,
									   double *D_SeaW_km)  
{
...
void CPro_P1546_LineDoc::WarmColdCross(double RLON_deg1,double RLAT_deg1,double RLON_deg2,double RLAT_deg2,
...
double CPro_P1546_LineDoc::LandWarmColdSea_D_Sea_kmIDWM(double lat1_deg,double lon1_deg,double lat2_deg,double lon2_deg,
...
void CPro_P1546_LineDoc::LoadIDWMmap() 
{
