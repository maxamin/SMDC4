// Pro_P370_AreaView.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CPro_P370_AreaView, CView)

CPro_P370_AreaView::CPro_P370_AreaView()
{
	old_cx=old_cy=600;
	new_cx=new_cy=600;
	m_LegendFlag=false;
...
BEGIN_MESSAGE_MAP(CPro_P370_AreaView, CView)
	//{{AFX_MSG_MAP(CPro_P370_AreaView)
	ON_WM_SIZE()
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P370_AreaView drawing

#include "memdc.h"
void CPro_P370_AreaView::OnDraw(CDC* pDC)	//98/01/25
{
	CMemDC mDC(pDC);
	OnDraw4(mDC);
}
void CPro_P370_AreaView::OnDraw4(CDC* pDC)	//98/01/25
{
	CPro_P370_AreaDoc *pDoc =(CPro_P370_AreaDoc *) GetDocument();
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P370_AreaView diagnostics

#ifdef _DEBUG
void CPro_P370_AreaView::AssertValid() const
{
	CView::AssertValid();
}

void CPro_P370_AreaView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P370_AreaView message handlers

void CPro_P370_AreaView::OnSize(UINT nType, int cx, int cy) 
{
...
void CPro_P370_AreaView::OnRefresh() 
{
	Invalidate();
	
}

void CPro_P370_AreaView::OnTopo0() 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
...
void CPro_P370_AreaView::OnUpdateTopo0(CCmdUI* pCmdUI) 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_0" ? 1 : 0);
}

void CPro_P370_AreaView::OnTopo1() 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
...
void CPro_P370_AreaView::OnUpdateTopo1(CCmdUI* pCmdUI) 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_1" ? 1 : 0);
}

void CPro_P370_AreaView::OnJet() 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
...
void CPro_P370_AreaView::OnUpdateJet(CCmdUI* pCmdUI) 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Jet" ? 1 : 0);
}

void CPro_P370_AreaView::OnGray() 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
...
void CPro_P370_AreaView::OnUpdateGray(CCmdUI* pCmdUI) 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Gray" ? 1 : 0);
}

void CPro_P370_AreaView::OnPink() 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
...
void CPro_P370_AreaView::OnUpdatePink(CCmdUI* pCmdUI) 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Pink" ? 1 : 0);
}

void CPro_P370_AreaView::OnCopper() 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
...
void CPro_P370_AreaView::OnUpdateCopper(CCmdUI* pCmdUI) 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Copper" ? 1 : 0);
}

void CPro_P370_AreaView::OnGlobe() 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
...
void CPro_P370_AreaView::OnUpdateGlobe(CCmdUI* pCmdUI) 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Globe" ? 1 : 0);
}

void CPro_P370_AreaView::OnToolsNormalize() 
{
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
...
void CPro_P370_AreaView::OnMouseMove(UINT nFlags, CPoint point) 
{
	///////////////////// StatusBAR/////////////////////////////////////
	CPro_P370_AreaDoc* pDoc = (CPro_P370_AreaDoc*)GetDocument();
	...
	if (pDoc->m_ReadyDoc == 1)
	{
		...
		double lon=pDoc->P370lon0 + (double)((point.x)*(pDoc->Width-1))*
						(pDoc->m_Resolution_x/(double)(pDoc->m_ZoomFactor))
						/((double)(rect.Width()-1));

		double lat=pDoc->P370lat0 + (double)((rect.Height()-1 -point.y)*(pDoc->Height-1))*
						(pDoc->m_Resolution_x/(double)(pDoc->m_ZoomFactor))
...
lon = ((CSMS4DCApp *)AfxGetApp())->ReverseLon(lon);
	   ...
	   ((CMainFrame*)(AfxGetApp()->m_pMainWnd))->m_wndStatusBar.SetPaneText(5, string);
		...
		double dist=Distance_km(pDoc->P370lat_ST,pDoc->P370lon_ST,lat,lon);
...
void CPro_P370_AreaView::DEG2DMS(CString type,double x,int *xD,int *xM,double *xS,char *xU) 
{
	if (x < 0)
	{
		x=-x;
...
double CPro_P370_AreaView::Distance_km(double lat1,double lon1,double lat2,double lon2) 
{
...
void CPro_P370_AreaView::OnShowLegend() 
{
...
void CPro_P370_AreaView::OnUpdateShowLegend(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(m_LegendFlag ? 1 : 0);
}

void CPro_P370_AreaView::OnToolsContour() 
{
	CPro_P370_AreaDoc *pDoc =(CPro_P370_AreaDoc *) GetDocument();
	CContourDLG cdlg;
...
void CPro_P370_AreaView::OnToolsCoveragearea() 
{
	CPro_P370_AreaDoc *pDoc =(CPro_P370_AreaDoc *) GetDocument();
/*
...
void CPro_P370_AreaView::OnUpdateToolsCoveragearea(CCmdUI* pCmdUI) 
{
	CPro_P370_AreaDoc *pDoc =(CPro_P370_AreaDoc *) GetDocument();
...
int CPro_P370_AreaView::Contour(double y,double MinV,double MaxV,int nL) 
{
...
void CPro_P370_AreaView::LegendLOC(CDC* pDC) 
{
	CPro_P370_AreaDoc *pDoc =(CPro_P370_AreaDoc *) GetDocument();
...
void CPro_P370_AreaView::AreaShow(CDC* pDC) 
{
	CPro_P370_AreaDoc *pDoc =(CPro_P370_AreaDoc *) GetDocument();
...
void CPro_P370_AreaView::OnLButtonDown(UINT nFlags, CPoint point) 
{
	m_bLPressed=true;
	if (m_LegendFlag)
	{
...
void CPro_P370_AreaView::OnLButtonUp(UINT nFlags, CPoint point) 
{
	m_bLPressed=false;
	m_bLSelect=false;
...
BOOL CPro_P370_AreaView::OnPreparePrinting(CPrintInfo* pInfo) 
{
	return DoPreparePrinting(pInfo);
}

void CPro_P370_AreaView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
}
void CPro_P370_AreaView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/) 
{
}
void CPro_P370_AreaView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
	if(pInfo)
	{
...
void CPro_P370_AreaView::OnFilePrintPreview() 
{
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarCheck();
	CView::OnFilePrintPreview();
}

void CPro_P370_AreaView::OnEndPrintPreview(CDC* pDC, CPrintInfo* pInfo, POINT point, CPreviewView* pView) 
{
	CView::OnEndPrintPreview(pDC, pInfo, point, pView);
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarSet();
}

void CPro_P370_AreaView::OnToolsContourvalue() 
{
	CPro_P370_AreaDoc *pDoc =(CPro_P370_AreaDoc *) GetDocument();
	...
	if(vdlg.DoModal()==IDOK)
	{
		...
		Latst = pDoc->P370lat_ST;	Lonst = pDoc->P370lon_ST;
		CString progress_str, progress_char = "|";

		CString str;
		str.Format("%sP370%d%d%d%d%d%d%d%d%d.txt",pDoc->P370Name_ST,(int)Lonst,(int)Latst,abs(E),(int)pDoc->P370time,(int)pDoc->P370location,(int)pDoc->P370RxH,(int)pDoc->P370k,pDoc->P370syst,pDoc->P370environment);
...
CString CPro_P370_AreaView::str_rep(CString str,int num)
{
	CString str1 = str;
	for(int i=0;i<num;i++)
		str1 = str1+str;
...
void CPro_P370_AreaView::OnDrawVector(CString sFile) 
{
	CVectorDLG Vdlg;
...
void CPro_P370_AreaView::DrawVector(CDC *pDC,CString Vector_filepath,
...
void CPro_P370_AreaView::LatLon2Point(double lat_deg,double lon_deg,CPoint *PointSt) 
{
	CPro_P370_AreaDoc *pDoc =(CPro_P370_AreaDoc *) GetDocument();
...
lon_deg = ((CSMS4DCApp *)AfxGetApp())->ChangeLon(lon_deg,pDoc->TileX);
	...
	double ix = (double)(pDoc->m_ZoomFactor)*((lon_deg - pDoc->P370lon0)/(pDoc->m_Resolution_x));
	double jy = (double)(pDoc->m_ZoomFactor)*((lat_deg - pDoc->P370lat0)/(pDoc->m_Resolution_x));
/*
	CRect rect;
	GetClientRect(&rect);
	double W = rect.Width();
...
void CPro_P370_AreaView::OnToolsDrawcontourfromfile() 
{
	CString sFile, sPath;
...
void CPro_P370_AreaView::OnToolsRemovecontourfromdisplay() 
{
	m_POLYnum = 0;
	InvalidateRect(NULL,false);
}
...
/////////////////////////////Google Earth//////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CPro_P370_AreaView::CaptureDC()
{
	CPro_P370_AreaDoc *pDoc =(CPro_P370_AreaDoc *) GetDocument();
	...
	if(((CSMS4DCApp *)AfxGetApp())->KmlSave( &sFile, &sPath , &flagShow , fileOUTkml))
	{
		...
		double lonW = pDoc->P370lon0;
		double lonE = pDoc->P370lon0 + (double)(pDoc->Width -1)*( pDoc->m_Resolution_x / (double)(pDoc->m_ZoomFactor));
		double latS = pDoc->P370lat0;
		double latN = pDoc->P370lat0 + (double)(pDoc->Height-1)*( pDoc->m_Resolution_x / (double)(pDoc->m_ZoomFactor));
		FILE *fp2 = fopen(fileOUTkml,_T("wt"));
		CString str1,str2,str3,str4;

double P370lon_ST = ((CSMS4DCApp *)AfxGetApp())->ReverseLon(pDoc->P370lon_ST);
...
void CPro_P370_AreaView::OnToolsGoogle() 
{
	CaptureDC();
}

void CPro_P370_AreaView::OnFileSaveAs() 
{
	OnFileSave();	
}
void CPro_P370_AreaView::OnFileSave() 
{
	CPro_P370_AreaDoc *pDoc =(CPro_P370_AreaDoc *) GetDocument();
	CString str = pDoc->GetTitle();
...
void CPro_P370_AreaView::OnInitialUpdate() 
{
	CView::OnInitialUpdate();

	CString Title_En  = "Area Calculation (P370)";
	CString Title_Num = GetDocument()->GetTitle();		Title_Num.Replace(Title_En,"");
	GetParent()->SetWindowText(_Z(Title_En) + Title_Num); 

	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ChangeMenuLang(IDR_SMS4DCTYPE8);
}

BOOL CPro_P370_AreaView::OnEraseBkgnd(CDC* pDC)	//98/01/25 
{
	return true;				
