// Pro_P1546_NetBDoc.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CPro_P1546_NetBDoc, CDocument)

CPro_P1546_NetBDoc::CPro_P1546_NetBDoc()
{
	colormaptype="Jet";
...
BOOL CPro_P1546_NetBDoc::OnNewDocument()
{
...
BEGIN_MESSAGE_MAP(CPro_P1546_NetBDoc, CDocument)
	//{{AFX_MSG_MAP(CPro_P1546_NetBDoc)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_NetBDoc diagnostics

#ifdef _DEBUG
void CPro_P1546_NetBDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CPro_P1546_NetBDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1546_NetBDoc serialization

void CPro_P1546_NetBDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
void CPro_P1546_NetBDoc::LatLon2Point(double lat_deg,double lon_deg,CPoint *PointSt) 
{
...
double CPro_P1546_NetBDoc::Point2Hg(CPoint point1) 
{
	int i1=point1.x   ,   j1=(Height-1)-point1.y;
	_int16 Hg=bufArea[i1+Width*j1];
	return (double)Hg;
}
double CPro_P1546_NetBDoc::LatLon2Hg0(double lat_deg,double lon_deg) 
{
	CPoint pointi;
...
double CPro_P1546_NetBDoc::LatLon2Hg(double lat_deg,double lon_deg)
{
	lon_deg = ((CSMS4DCApp *)AfxGetApp())->ChangeLon(lon_deg,TileX);
/*
	CString globeTileInfo = ((CSMS4DCApp *)AfxGetApp())->m_AppPath + _T("Texts\\globe.txt");
...
double CPro_P1546_NetBDoc::RoundBUF_Hg(double xps,double yps) 
{
...
double CPro_P1546_NetBDoc::Distance_km(double lat1,double lon1,double lat2,double lon2) 
{
...
double CPro_P1546_NetBDoc::Azimuth_Deg(double lat1,double lon1,double lat2,double lon2) 
{
	float	lat10 = (float)(lat1*D2R),
			lon10 = (float)(lon1*D2R),
			lat20 = (float)(lat2*D2R),
...
void CPro_P1546_NetBDoc::reckon(double lat_deg,double lon_deg,double rng_km,double az_deg,double *latC_deg,double *lonC_deg) 
{
...
double CPro_P1546_NetBDoc::Points2HgAvr(CPoint point1 , CPoint point2) 
{
	double HgAvr = 0.0;
	if (point1 != point2)
	{
...
int CPro_P1546_NetBDoc::Round(double x) 
{
	int x1 = (int) x;
	int x2 = x1+1;
...
double CPro_P1546_NetBDoc::TCAcorr1546(double Tdeg,double f_MHz)
{
...
void CPro_P1546_NetBDoc::ReadAntennaData(CString antfile,int *f0,double *rH,double *rV) 
{
	FILE *fid;
...
BOOL CPro_P1546_NetBDoc::PeekAndPump()
{
	static MSG msg;
...
double CPro_P1546_NetBDoc::Interp2(int *D0,double *E0,double d,int num) 
{
...
int CPro_P1546_NetBDoc::WarmColdSea(double RLON_deg,double RLAT_deg) 
{
...
int CPro_P1546_NetBDoc::LandWarmColdSea(double RLON_deg,double RLAT_deg) 
{
...
double CPro_P1546_NetBDoc::D_Sea_kmIDWM(double lat1_deg,double lon1_deg,double lat2_deg,double lon2_deg,
									   double *D_SeaW_km)  
{
...
void CPro_P1546_NetBDoc::WarmColdCross(double RLON_deg1,double RLAT_deg1,double RLON_deg2,double RLAT_deg2,
...
double CPro_P1546_NetBDoc::LandWarmColdSea_D_Sea_kmIDWM(double lat1_deg,double lon1_deg,double lat2_deg,double lon2_deg,
...
void CPro_P1546_NetBDoc::LoadIDWMmap() 
{
...
void CPro_P1546_NetBDoc::GetData()
{
	if     (((CSMS4DCApp *)AfxGetApp())->m_modeFlagP1546NetB == 0)	GetData0();		//Best Server
	else if(((CSMS4DCApp *)AfxGetApp())->m_modeFlagP1546NetB == 1)	GetData1();		//Monitoring Rx Coverage(BS)
	else if(((CSMS4DCApp *)AfxGetApp())->m_modeFlagP1546NetB == 2)	GetData2();		//Monitoring coverage zones
	else if(((CSMS4DCApp *)AfxGetApp())->m_modeFlagP1546NetB == 3)	GetData3();		//Monitoring  TDoA
}