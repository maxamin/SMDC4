// Pro_HATA_AreaView.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CPro_HATA_AreaView, CView)

CPro_HATA_AreaView::CPro_HATA_AreaView()
{
	old_cx=old_cy=600;
	new_cx=new_cy=600;
	m_LegendFlag=false;
...
BEGIN_MESSAGE_MAP(CPro_HATA_AreaView, CView)
	//{{AFX_MSG_MAP(CPro_HATA_AreaView)
	ON_WM_SIZE()
	ON_WM_MOUSEMOVE()
...
/////////////////////////////////////////////////////////////////////////////
// CPro_HATA_AreaView drawing
#include "memdc.h"
void CPro_HATA_AreaView::OnDraw(CDC* pDC)	//98/01/25
{
	CMemDC mDC(pDC);
	OnDraw4(mDC);
}
void CPro_HATA_AreaView::OnDraw4(CDC* pDC)	//98/01/25
{
	CPro_HATA_AreaDoc *pDoc =(CPro_HATA_AreaDoc *) GetDocument();
...
/////////////////////////////////////////////////////////////////////////////
// CPro_HATA_AreaView diagnostics

#ifdef _DEBUG
void CPro_HATA_AreaView::AssertValid() const
{
	CView::AssertValid();
}

void CPro_HATA_AreaView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_HATA_AreaView message handlers

void CPro_HATA_AreaView::OnSize(UINT nType, int cx, int cy) 
{
...
int CPro_HATA_AreaView::Contour(double y,double MinV,double MaxV,int nL) 
{
...
void CPro_HATA_AreaView::LegendLOC(CDC* pDC) 
{
	CPro_HATA_AreaDoc *pDoc =(CPro_HATA_AreaDoc *) GetDocument();
...
void CPro_HATA_AreaView::AreaShow(CDC* pDC) 
{
	CPro_HATA_AreaDoc *pDoc =(CPro_HATA_AreaDoc *) GetDocument();
...
void CPro_HATA_AreaView::OnMouseMove(UINT nFlags, CPoint point) 
{
	///////////////////// StatusBAR/////////////////////////////////////
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
...
lon = ((CSMS4DCApp *)AfxGetApp())->ReverseLon(lon);
	   ...
	   ((CMainFrame*)(AfxGetApp()->m_pMainWnd))->m_wndStatusBar.SetPaneText(5, string);
		...
		double dist=Distance_km(pDoc->HATAlat_ST,pDoc->HATAlon_ST,lat,lon);
...
void CPro_HATA_AreaView::DEG2DMS(CString type,double x,int *xD,int *xM,double *xS,char *xU) 
{
	if (x < 0)
	{
		x=-x;
...
double CPro_HATA_AreaView::Distance_km(double lat1,double lon1,double lat2,double lon2) 
{
...
void CPro_HATA_AreaView::OnToolsNormalize() 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
...
void CPro_HATA_AreaView::OnShowLegend() 
{
...
void CPro_HATA_AreaView::OnUpdateShowLegend(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(m_LegendFlag ? 1 : 0);
}

void CPro_HATA_AreaView::OnToolsContour() 
{
	CPro_HATA_AreaDoc *pDoc =(CPro_HATA_AreaDoc *) GetDocument();
	CContourDLG cdlg;
...
void CPro_HATA_AreaView::OnToolsCoveragearea() 
{
	CPro_HATA_AreaDoc *pDoc =(CPro_HATA_AreaDoc *) GetDocument();
/*
...
void CPro_HATA_AreaView::OnUpdateToolsCoveragearea(CCmdUI* pCmdUI) 
{
	CPro_HATA_AreaDoc *pDoc =(CPro_HATA_AreaDoc *) GetDocument();
	pCmdUI->SetCheck(pDoc->m_bThreshold);
}

void CPro_HATA_AreaView::OnLButtonDown(UINT nFlags, CPoint point) 
{
	m_bLPressed=true;
	if (m_LegendFlag)
	{
...
void CPro_HATA_AreaView::OnLButtonUp(UINT nFlags, CPoint point) 
{
	m_bLPressed=false;
	m_bLSelect=false;
...
void CPro_HATA_AreaView::OnTopo0() 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
...
void CPro_HATA_AreaView::OnUpdateTopo0(CCmdUI* pCmdUI) 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_0" ? 1 : 0);
}

void CPro_HATA_AreaView::OnTopo1() 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
...
void CPro_HATA_AreaView::OnUpdateTopo1(CCmdUI* pCmdUI) 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_1" ? 1 : 0);
}

void CPro_HATA_AreaView::OnJet() 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
...
void CPro_HATA_AreaView::OnUpdateJet(CCmdUI* pCmdUI) 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Jet" ? 1 : 0);
}

void CPro_HATA_AreaView::OnGray() 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
...
void CPro_HATA_AreaView::OnUpdateGray(CCmdUI* pCmdUI) 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Gray" ? 1 : 0);
}

void CPro_HATA_AreaView::OnPink() 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
...
void CPro_HATA_AreaView::OnUpdatePink(CCmdUI* pCmdUI) 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Pink" ? 1 : 0);
}

void CPro_HATA_AreaView::OnCopper() 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
...
void CPro_HATA_AreaView::OnUpdateCopper(CCmdUI* pCmdUI) 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Copper" ? 1 : 0);
}

void CPro_HATA_AreaView::OnGlobe() 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
...
void CPro_HATA_AreaView::OnUpdateGlobe(CCmdUI* pCmdUI) 
{
	CPro_HATA_AreaDoc* pDoc = (CPro_HATA_AreaDoc*)GetDocument();
...
BOOL CPro_HATA_AreaView::OnPreparePrinting(CPrintInfo* pInfo) 
{
	return DoPreparePrinting(pInfo);
}

void CPro_HATA_AreaView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
}
void CPro_HATA_AreaView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/) 
{
}
void CPro_HATA_AreaView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
	if(pInfo)
	{
...
void CPro_HATA_AreaView::OnFilePrintPreview() 
{
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarCheck();
	CView::OnFilePrintPreview();
}

void CPro_HATA_AreaView::OnEndPrintPreview(CDC* pDC, CPrintInfo* pInfo, POINT point, CPreviewView* pView) 
{
...
/////////////////////////////Google Earth//////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CPro_HATA_AreaView::CaptureDC()
{
	CPro_HATA_AreaDoc *pDoc =(CPro_HATA_AreaDoc *) GetDocument();
...
double HATAlon_ST = ((CSMS4DCApp *)AfxGetApp())->ReverseLon(pDoc->HATAlon_ST);
...
void CPro_HATA_AreaView::OnToolsGoogle() 
{
	CaptureDC();
}

void CPro_HATA_AreaView::OnFileSaveAs() 
{
	OnFileSave();	
}
void CPro_HATA_AreaView::OnFileSave() 
{
	CPro_HATA_AreaDoc *pDoc =(CPro_HATA_AreaDoc *) GetDocument();
	CString str = pDoc->GetTitle();
...
void CPro_HATA_AreaView::OnInitialUpdate() 
{
	CView::OnInitialUpdate();

	CString Title_En  = "Area Calculation (HATA)";
	CString Title_Num = GetDocument()->GetTitle();		Title_Num.Replace(Title_En,"");
	GetParent()->SetWindowText(_Z(Title_En) + Title_Num); 

	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ChangeMenuLang(IDR_SMS4DCTYPE31);
}

BOOL CPro_HATA_AreaView::OnEraseBkgnd(CDC* pDC) //98/01/25
{
	return true;
