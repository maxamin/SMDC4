#if !defined(AFX_PRO_P1812_POLYGONVIEW_H__1D9F8788_071B_4CF2_88FF_883E343688C0__INCLUDED_)
#define AFX_PRO_P1812_POLYGONVIEW_H__1D9F8788_071B_4CF2_88FF_883E343688C0__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// Pro_P1812_PolygonView.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CPro_P1812_PolygonView view

class CPro_P1812_PolygonView : public CView
{
protected:
	CPro_P1812_PolygonView();           // protected constructor used by dynamic creation
	DECLARE_DYNCREATE(CPro_P1812_PolygonView)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CPro_P1812_PolygonView)
	public:
...
// Implementation
protected:
	virtual ~CPro_P1812_PolygonView();
#ifdef _DEBUG
...
protected:
	//{{AFX_MSG(CPro_P1812_PolygonView)
...
#endif // !defined(AFX_PRO_P1812_POLYGONVIEW_H__1D9F8788_071B_4CF2_88FF_883E343688C0__INCLUDED_)
