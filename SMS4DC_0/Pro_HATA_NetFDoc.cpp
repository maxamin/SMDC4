// Pro_HATA_NetFDoc.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CPro_HATA_NetFDoc, CDocument)

CPro_HATA_NetFDoc::CPro_HATA_NetFDoc()
{
	colormaptype="Jet";
...
BOOL CPro_HATA_NetFDoc::OnNewDocument()
{
...
BEGIN_MESSAGE_MAP(CPro_HATA_NetFDoc, CDocument)
	//{{AFX_MSG_MAP(CPro_HATA_NetFDoc)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CPro_HATA_NetFDoc diagnostics

#ifdef _DEBUG
void CPro_HATA_NetFDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CPro_HATA_NetFDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_HATA_NetFDoc serialization

void CPro_HATA_NetFDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
/////////////////////////////////////////////////////////////////////////////
// CPro_HATA_NetFDoc commands


void CPro_HATA_NetFDoc::GetData()
{
...
//98/01/19
int CPro_HATA_NetFDoc::Round(double x) 
{
	int y;
	int x1 = (int)x;
...
*/
double CPro_HATA_NetFDoc::Distance_km(double lat1,double lon1,double lat2,double lon2) 
{
...
double CPro_HATA_NetFDoc::Azimuth_Deg(double lat1,double lon1,double lat2,double lon2) 
{
	double pi=4.0*atan(1.0);
...
void CPro_HATA_NetFDoc::LatLon2Point(double lat_deg,double lon_deg,CPoint *PointSt) 
{
...
double CPro_HATA_NetFDoc::Point2Hg(CPoint point1) 
{
...
void CPro_HATA_NetFDoc::reckon(double lat_deg,double lon_deg,double rng_km,double az_deg,double *latC_deg,double *lonC_deg) 
{
	double pi=4.0*atan(1.0);
	double R=6371.0;
...
double CPro_HATA_NetFDoc::Points2HgAvr(CPoint point1 , CPoint point2) 
{
	double HgAvr = 0.0;
	if (point1 != point2)
	{
...
void CPro_HATA_NetFDoc::ReadAntennaData(CString antfile,int *f0,double *rH,double *rV) 
{
	FILE *fid;
...
BOOL CPro_HATA_NetFDoc::PeekAndPump()
{
	static MSG msg;
...
double CPro_HATA_NetFDoc::Interp2(int *D0,double *E0,double d,int num) 
{
