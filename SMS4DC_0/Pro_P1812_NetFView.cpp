// Pro_P1812_NetFView.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CPro_P1812_NetFView, CView)

CPro_P1812_NetFView::CPro_P1812_NetFView()
{
	old_cx=old_cy=600;
	new_cx=new_cy=600;
	m_LegendFlag=false;
...
BEGIN_MESSAGE_MAP(CPro_P1812_NetFView, CView)
	//{{AFX_MSG_MAP(CPro_P1812_NetFView)
	ON_WM_SIZE()
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1812_NetFView drawing

#include "memdc.h"
void CPro_P1812_NetFView::OnDraw(CDC* pDC)	//98/01/25
{
	CMemDC mDC(pDC);
	OnDraw4(mDC);
}
void CPro_P1812_NetFView::OnDraw4(CDC* pDC)	//98/01/25
{
	CPro_P1812_NetFDoc *pDoc =(CPro_P1812_NetFDoc *) GetDocument();
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1812_NetFView diagnostics

#ifdef _DEBUG
void CPro_P1812_NetFView::AssertValid() const
{
	CView::AssertValid();
}

void CPro_P1812_NetFView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CPro_P1812_NetFView message handlers


void CPro_P1812_NetFView::OnSize(UINT nType, int cx, int cy) 
{
...
void CPro_P1812_NetFView::OnToolsNormalize() 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
...
void CPro_P1812_NetFView::OnShowLegend() 
{
...
void CPro_P1812_NetFView::OnUpdateShowLegend(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(m_LegendFlag ? 1 : 0);
}


void CPro_P1812_NetFView::OnTopo0() 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
...
void CPro_P1812_NetFView::OnUpdateTopo0(CCmdUI* pCmdUI) 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_0" ? 1 : 0);
}

void CPro_P1812_NetFView::OnTopo1() 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
...
void CPro_P1812_NetFView::OnUpdateTopo1(CCmdUI* pCmdUI) 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Topo_1" ? 1 : 0);
}

void CPro_P1812_NetFView::OnJet() 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
...
void CPro_P1812_NetFView::OnUpdateJet(CCmdUI* pCmdUI) 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Jet" ? 1 : 0);
}

void CPro_P1812_NetFView::OnGray() 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
...
void CPro_P1812_NetFView::OnUpdateGray(CCmdUI* pCmdUI) 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Gray" ? 1 : 0);
}

void CPro_P1812_NetFView::OnPink() 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
...
void CPro_P1812_NetFView::OnUpdatePink(CCmdUI* pCmdUI) 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Pink" ? 1 : 0);
}

void CPro_P1812_NetFView::OnCopper() 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
...
void CPro_P1812_NetFView::OnUpdateCopper(CCmdUI* pCmdUI) 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Copper" ? 1 : 0);
}

void CPro_P1812_NetFView::OnGlobe() 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
...
void CPro_P1812_NetFView::OnUpdateGlobe(CCmdUI* pCmdUI) 
{
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
	pCmdUI->SetCheck(pDoc->colormaptype=="Globe" ? 1 : 0);
}

void CPro_P1812_NetFView::OnMouseMove(UINT nFlags, CPoint point) 
{
	///////////////////// StatusBAR/////////////////////////////////////
	CPro_P1812_NetFDoc* pDoc = (CPro_P1812_NetFDoc*)GetDocument();
...
//		if(m_modeFlagP1812NetF == 2)	string.Format("Uncertainty (km) : %0.3f",E );	//Monitoring  AoA
		if(m_modeFlagP1812NetF == 2)	string.Format(_Z("Uncertainty (km)") + " : %0.3f",E );	//Monitoring  AoA
...
void CPro_P1812_NetFView::DEG2DMS(CString type,double x,int *xD,int *xM,double *xS,char *xU) 
{
	if (x < 0)
	{
		x=-x;
...
void CPro_P1812_NetFView::OnToolsContour() 
{
	CPro_P1812_NetFDoc *pDoc =(CPro_P1812_NetFDoc *) GetDocument();
	CContourDLG cdlg;
...
void CPro_P1812_NetFView::OnToolsCoveragearea() 
{
	CPro_P1812_NetFDoc *pDoc =(CPro_P1812_NetFDoc *) GetDocument();
/*
...
void CPro_P1812_NetFView::OnUpdateToolsCoveragearea(CCmdUI* pCmdUI) 
{
	CPro_P1812_NetFDoc *pDoc =(CPro_P1812_NetFDoc *) GetDocument();
	pCmdUI->SetCheck(pDoc->m_bThreshold);
}

int CPro_P1812_NetFView::Contour(double y,double MinV,double MaxV,int nL) 
{
...
void CPro_P1812_NetFView::LegendLOC(CDC* pDC) 
{
	if     (m_modeFlagP1812NetF == 0)	LegendLOC0( pDC);	//Maximum Field Strength(MFS)
	else if(m_modeFlagP1812NetF == 1)	LegendLOC0( pDC);	//Monitoring Rx Coverage
	else if(m_modeFlagP1812NetF == 2)	LegendLOC1( pDC);	//Monitoring  AoA
}

void CPro_P1812_NetFView::LegendLOC0(CDC* pDC) 
{
	CPro_P1812_NetFDoc *pDoc =(CPro_P1812_NetFDoc *) GetDocument();
...
void CPro_P1812_NetFView::LegendLOC1(CDC* pDC) 
{
	CPro_P1812_NetFDoc *pDoc =(CPro_P1812_NetFDoc *) GetDocument();
	int x1,y1,x2,y2,w=10,h=1,pscale=12;
...
void CPro_P1812_NetFView::AreaShow(CDC* pDC) 
{
	CPro_P1812_NetFDoc *pDoc =(CPro_P1812_NetFDoc *) GetDocument();
...
void CPro_P1812_NetFView::OnLButtonDown(UINT nFlags, CPoint point) 
{
	m_bLPressed=true;
	if (m_LegendFlag)
	{
...
void CPro_P1812_NetFView::OnLButtonUp(UINT nFlags, CPoint point) 
{
	m_bLPressed=false;
	m_bLSelect=false;
...
BOOL CPro_P1812_NetFView::OnPreparePrinting(CPrintInfo* pInfo) 
{
	return DoPreparePrinting(pInfo);
}

void CPro_P1812_NetFView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
}
void CPro_P1812_NetFView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/) 
{
}
void CPro_P1812_NetFView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
	if(pInfo)
	{
...
void CPro_P1812_NetFView::OnFilePrintPreview() 
{
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ToolbarCheck();
	CView::OnFilePrintPreview();
}

void CPro_P1812_NetFView::OnEndPrintPreview(CDC* pDC, CPrintInfo* pInfo, POINT point, CPreviewView* pView) 
{
...
/////////////////////////////Google Earth//////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CPro_P1812_NetFView::CaptureDC()
{
	CPro_P1812_NetFDoc *pDoc =(CPro_P1812_NetFDoc *) GetDocument();
...
void CPro_P1812_NetFView::OnToolsGoogle() 
{
	CaptureDC();
}

void CPro_P1812_NetFView::OnFileSaveAs() 
{
	OnFileSave();	
}
void CPro_P1812_NetFView::OnFileSave() 
{
	CPro_P1812_NetFDoc *pDoc =(CPro_P1812_NetFDoc *) GetDocument();
	CString str = pDoc->GetTitle();
...
void CPro_P1812_NetFView::OnInitialUpdate() 
{
	CView::OnInitialUpdate();

	CString Title_En  = "Maximum Field Strength";		//98/12/17
//	CString Title_En  = "Maximum Field Strength (P1812)";
	CString Title_Num = GetDocument()->GetTitle();		Title_Num.Replace(Title_En,"");

//Monitoring		98/12/17
	m_modeFlagP1812NetF = ((CSMS4DCApp *)AfxGetApp())->m_modeFlagP1812NetF;

	if     (m_modeFlagP1812NetF == 1)	Title_En  = "Monitoring Rx Coverage(MFS)";	//Monitoring Rx Coverage
	else if(m_modeFlagP1812NetF == 2)	Title_En  = "Location Zone AoA";			//Monitoring  AoA


	GetParent()->SetWindowText(_Z(Title_En) + Title_Num); 
	((CMainFrame*)(AfxGetApp()->m_pMainWnd))->ChangeMenuLang(IDR_SMS4DCTYPE49);
}

BOOL CPro_P1812_NetFView::OnEraseBkgnd(CDC* pDC) 	//98/01/25
{
	return true;		
