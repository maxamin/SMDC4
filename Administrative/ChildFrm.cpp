...
//	m_inProcess=false;
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView), CSize(300, 100), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CTreeviewView), CSize(100, 100), pContext))
	{
...
CTreeviewView* CChildFrame::GetRightPane()
{
...
void CChildFrame::OnUpdateViewStyles(CCmdUI* pCmdUI)
{
	...
	CTreeviewView* pView = GetRightPane(); 
...
void CChildFrame::OnViewStyle(UINT nCommandID)
{
	...
	// if the right-hand pane has been created and is a CTreeviewView,
