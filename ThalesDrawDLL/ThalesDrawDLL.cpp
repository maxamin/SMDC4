// ThalesDrawDLL.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CThalesDrawDLLApp, CWinApp)
	//{{AFX_MSG_MAP(CThalesDrawDLLApp)
...
/////////////////////////////////////////////////////////////////////////////
// CThalesDrawDLLApp construction

CThalesDrawDLLApp::CThalesDrawDLLApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CThalesDrawDLLApp object

CThalesDrawDLLApp theApp;


CMyMultiDocTemplate* DLLthalesDocTemplate()
{
...
//	AfxEnableControlContainer() ;
	...
	pTemplate = new CMyMultiDocTemplate(
							...
							IDR_THALESTYPE,               // the document/view resource info
							RUNTIME_CLASS(CThalesDrawDoc),
							RUNTIME_CLASS(CChildFrame), // custom MDI child frame
							RUNTIME_CLASS(CThalesDrawView));
	return pTemplate ;
}
...
#include "resource.h"
void CThalesDrawDLLApp::TranslateDialog(CDialog *pDialog)
{
...
CString CThalesDrawDLLApp::GetTranslatedString(CString strOriginal)
{
